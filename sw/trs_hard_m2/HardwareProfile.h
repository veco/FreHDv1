...
/* Fred's code serial debug output (different from diskio debug) */
...
// timer3 interrupt after 1ms.
// 40MHz/4/8 => 1.250.000 ticks per second
// 5ms => 6.250 ticks, so 0x186A
// reload is 0x10000 - 0x186A = E796
// 2.5ms => 3.125 ticks so 0xC35, reload F3CB
// 1ms => 1.250 ticks so 0x4E2, reload FB1E
// reload is 0x10000 - 0xC35 = F3CB
#define TMR3_RELOAD_H   0xF3
#define TMR3_RELOAD_L   0xCB
...
#define TRS_INTRQ_TRIS  TRISEbits.TRISE2
#define TRS_INTRQ_N     LATEbits.LATE2
#define TRS_STAT_INT_TRIS   TRISBbits.TRISB0
#define TRS_STAT_INT_IE     INTCONbits.INT0IE
#define TRS_STAT_INT_IF     INTCONbits.INT0IF
#define TRS_STAT_INT_EDGE   INTCON2bits.INTEDG0

...
#define TRS_STAT_INT_IF INTCON,INT0IF
#define TRS_STAT_INT_IE INTCON,INT0IE
#define TRS_WAIT	LATB,3
#define STAT_CS		LATC,0
#define GLED		LATB,7
#define RLED		LATB,6
#define TRS_INTRQ_N     LATE,2
...
handle_int2
	...
	btfss   TRS_STAT_INT_IF ; PIC reading STAT ?
	bra     handle_int_gal  ; no
	
	bsf     TRS_INTRQ_N     ; deassert INTRQ to TRS80
	bcf     TRS_STAT_INT_IF
	bcf     TRS_STAT_INT_IE
...
trs_write_cmd_seek		; SEEK
	...
	bsf	action_flags,ACTION_TRS_BIT
sched_interrupt
	bcf     action_flags,ACTION_INT_TIMER_BIT       ; schedule interrupt
	bsf     T3CON,TMR3ON
	bra	int_ret_rd_S
...
trs_write_cmd_init		; INIT
	...
	movwf	state_status
sched_int_action
	movlw   ACTION_HARD_INTERRUPT                   ; schedule interrupt
	movwf   action_type
	bsf     action_flags,ACTION_TRS_BIT
	bcf     action_flags,ACTION_INT_TIMER_BIT
	bsf     T3CON,TMR3ON
	bra	int_ret_rd_S

...
void pic_init(void)
{
	...
	TRS_STAT_INT_TRIS = INPUT_PIN;
	TRS_STAT_INT_IE = 0;
	TRS_STAT_INT_EDGE = 0;  // falling edge
	TRS_INTRQ_TRIS = OUTPUT_PIN;
	TRS_INTRQ_N = 1;
	...
	/* Timer 3 */
	OpenTimer3(TIMER_INT_ON & T3_16BIT_RW & T3_PS_1_8 & 
	    T3_SOURCE_INT);
	IPR2bits.TMR3IP = 0;
	T3CONbits.TMR3ON = 0;
	TMR3H = TMR3_RELOAD_H;
